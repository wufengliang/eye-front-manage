 ...
 * @LastEditTime: 2024-05-29 22:23:47
 * @Description: 自定义搜索
 */
  ...
  const renderButtonBox = () => {
    return (
      <>
        {
          showSearch ?
            <Button type='primary' className='margin-right-5 margin-bottom-5 margin-top-5' htmlType='submit' loading={loading}>查询</Button>
            : null
        }
        {
          showReset ?
            <Button htmlType='reset' className='margin-bottom-5 margin-top-5' onClick={() => onReset && onReset()}>清空</Button>
            : null
        }
      </>
    )
