 ...
 * @LastEditTime: 2023-10-26 15:34:12
...
function AnswerUser() {
  ...
  const columns: ColumnsType<any> = [
    ...
    { title: '用户联系电话', dataIndex: 'phoneNumber', width: 150, },
    {
      ...
      render: (_, record) => (
        <>
          <Button type='primary' className='m-1' onClick={() => navigate(`/previewAnswer?surveyId=${searchParams.get('id')}&userId=${record?.id}`)}>答案预览</Button>
